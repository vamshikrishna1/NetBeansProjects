 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://kmit.com/", wsdlLocation = "http://localhost:8080/DemoCalculator/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://kmit.com/", "CalculatorWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/DemoCalculator/CalculatorWS?wsdl");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://kmit.com/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://kmit.com/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
